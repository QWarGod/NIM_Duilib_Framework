...
namespace ui {
    ...
    class UILIB_API RenderContext_GdiPlus : public IRenderContext {
      public:
        ...
        // added_by xmcy0011@sina.com 2021-04-26 增加渐变背景支持
        virtual void DrawColor(const UiRect& rc, DWORD dwColor1, DWORD dwColor2, BYTE uFade = 255) override;
        ...
        // added_by xmcy0011@sina.com 2021-04-26 同时测量宽度和高度
        virtual UiRect MeasureTextEx(const std::wstring& strText, const std::wstring& strFontId, UINT uStyle, int width = DUI_NOSET_VALUE) override;
